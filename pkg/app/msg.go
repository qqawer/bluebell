...
var MsgFlags = map[int]string{
	...
	ERROR_AUTH:                      "Token错误",
	ERROR_LOGIN:                     "账号或者密码错误",
	ERROR_LOGIN_LOCK:                "账号被锁定",
	ERROR_USER:                      "账号不能为空",
	ERROR_PWD:                       "密码不能为空",
	ERROR_UPLOAD_SAVE_IMAGE_FAIL:    "保存图片失败",
	ERROR_UPLOAD_CHECK_IMAGE_FAIL:   "检查图片失败",
	ERROR_UPLOAD_CHECK_IMAGE_FORMAT: "校验图片错误，图片格式或大小有问题",
	ERROR_GET_DATA:                  "获取数据失败",
	ERROR_IMPORT_DATA:               "导入失败",
	ERROR_IMPORT_EXTRA:              "后缀名不符合上传要求",
	ERROR_IMPORT_FAIL:               "保存文件失败",
	ERROR_IMPORT_READ_FAIL:          "读取文件失败",
	ERROR_IMPORT_DECODE_FAIL:        "解析文件失败",
}
