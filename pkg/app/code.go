...
const (
	...
	//配置
	ERROR_GET_DATA = 40021

	ERROR_IMPORT_DATA = 40022

	ERROR_IMPORT_EXTRA = 40023

	ERROR_IMPORT_FAIL = 40024

	ERROR_IMPORT_READ_FAIL = 40025

	ERROR_IMPORT_DECODE_FAIL = 40026
)
